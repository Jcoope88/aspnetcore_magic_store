...
export class AppComponent {
    ...
    // createProduct() {
    //     this.repo.createProduct(new Product(0, "Sqaure Pants", "Watersports",
    //         "Comes with pineapple under the sea", 49.99, this.repo.products[0].supplier));
    // }
    ...
    // replaceSupplier() {
    //     let s = new Supplier(3, "Soupy", "New York", "NY");
